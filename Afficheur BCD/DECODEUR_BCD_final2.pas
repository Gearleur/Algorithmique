...
type 
    ...
    t_Tab_Segm_Bool = array [0..nSegm-1] of boolean;
...
// IN: taille, Tb
// OUT: Tb
procedure Raz_Tab_bin(taille : integer; var Tb: t_Tab_Int) ;
var 
    cpt: integer;
begin
	for cpt := 0 to taille-1 do
...
// Conversion_DecBin
// A.T. - J.V. 2021-11-15
// Remplit un tableau d'entiers binaires avec les chiffres d'un nombre en base 10 traduit en base 2
// IN: nb, Tbin
// OUT: Tbin
procedure Conversion_DecBin( nb: longint; var Tbin: t_Tab_Int);
var
    cpt, reste: integer;
begin
...
// IN: Tbin, Tbool
// OUT: Tbool
procedure Conv_BinBool(var Tbin: t_Tab_Int; var Tbool:  t_Tab_Bool);
var
    cpt: integer;
begin
...
// IN: Tbool, TSegmBool
// OUT: TSegmBool
procedure Eq_Karnaugh(var Tbool : t_Tab_Bool; var TSegmBool : t_Tab_Segm_Bool);
const
...
// OUT: -NONE-
procedure Affichage(var TSegmBool : t_Tab_Segm_Bool; var x, y, zoom : integer);
const
    A=0; B=1; C=2; D=3; E=4; F=5; G=6;
begin
...
// Chiffre_MAIN
// A.T. - J.V. 2021-11-15
(*// Procedure Principale du service chiffre par chiffre, appelant ses procédures filles (Raz_Tab_bin, Conversion_DecBin, Conv_BinBool, Eq_Karnaugh, Affichage) qui (ré)initialisent le tableau d'entiers binaires, convertissent
...
// OUT: -NONE-
procedure Chiffre_MAIN(taille: integer; var Tnombre : t_Tab_Int_dyn; var Tbin :  t_Tab_Int; var Tbool : t_Tab_Bool; var TSegmBool : t_Tab_Segm_Bool; var x, y, zoom: integer );
var
    cpt, a , b: integer;
begin
    ClrScr;
